...
These might work out of the box if you configure properly for you or not. 
I'm fairly new to github and so might not be commiting in the proper way. 
For now I'm just using github so that if I mess something up and do a clean install, I can pull these.

Thanks

## Requirements
Sripts are written in bash. Every script should be optimized for performance.
